...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, name: $name, description: $description, icon: $icon, pointsRequired: $pointsRequired, achievedAt: $achievedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, icon, pointsRequired, achievedAt);
...
abstract class _Achievement implements Achievement {
  const factory _Achievement(
      ...
      final DateTime? achievedAt}) = _$AchievementImpl;
